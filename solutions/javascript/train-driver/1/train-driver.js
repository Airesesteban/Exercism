 ...
 */
export function getListOfWagons(...wagon_ids) {
  return wagon_ids
}
...
export function fixListOfWagons(ids) {
   const [first, second, ...restOfIds] = ids
  const newList = [...restOfIds, first, second]
  return newList
}
...
export function correctListOfWagons(ids, missingWagons) {
  const [first, ...restOfIds] = ids
  const correctList = [first,...missingWagons, ...restOfIds]
  return correctList
}
